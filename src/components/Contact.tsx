        ...
        <AnimateIn className="grid md:grid-cols-2 gap-12">
          <div>
            ...
            <div className="mt-8 p-6 bg-lime-50 rounded-lg">
              ...
              <p className="text-gray-600 text-sm">Reach out anytime—day or night. Our team is on hand around the clock to answer your questions and support your orders.</p>
            </div>
          </div>
